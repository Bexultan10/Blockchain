...
class Blockchain:
    ...
    def generate_genesis_block(self):
        ...
        genesis_block.add_transaction(Transaction(sender=client1, recipient=client2, amount=100, keys=keys1, role="client"))
        genesis_block.add_transaction(Transaction(sender=client2, recipient=client1, amount=50, keys=keys2, role="client"))
    ...
    def add_block(self, transactions):
        ...
        # Error handling
        if not all(participant in self.participants for transaction in transactions for participant in transaction.participants):
...
class Miner:
    ...
    def mine_block(self, blockchain):
        ...
        mining_transaction = Transaction(sender="System", recipient=self.name, amount=mining_reward, keys=mining_keys, role="miner")
...
def runBlockchain():
    ...
    blockchain.add_participant("Aigali")
    blockchain.add_participant("Bexultan")
    ...
    try:
        ...
        transactions = [
            Transaction(sender="Bexultan", recipient="Aigali", amount=30, keys=generate_keys(), role="client"),
            Transaction(sender="Aigali", recipient="Bexultan", amount=15, keys=generate_keys(), role="client"),
        ]

        # Add the new block with these transactions
